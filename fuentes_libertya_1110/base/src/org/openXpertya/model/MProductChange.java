...
public class MProductChange extends X_M_ProductChange implements DocAction {
	 ...
	 */
	private boolean calculatePriceVariationRate() {
	 ...
	 */
	private BigDecimal getPriceVariationRate() {
	 ...
	 * artículos a cambiar.
	 */
	private Integer getPriceListID() {
		if (priceListID == null) {
			String sql =
	 ...
	 */
	private Integer getPriceListVersionID() {
	 ...
	 * artículos a cambiar.
	 */
	private Timestamp getPriceValidationDate() {
